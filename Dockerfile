...
ARG TEAMSPEAK_URL="https://files.teamspeak-services.com/releases/server/${curl $(echo https://raw.githubusercontent.com/Rene-Roscher/teamspeak-linux-docker-images/master/latest)}/teamspeak3-server_linux_alpine-${curl $(echo https://raw.githubusercontent.com/Rene-Roscher/teamspeak-linux-docker-images/master/latest)}.tar.bz2"
